...
enum TunnelsManagerError: WireGuardAppError {
    ...
    case tunnelIsPartOfTiTGroup(groupNames: String)
    ...
    var alertText: AlertText {
        ...
        case .tunnelIsPartOfTiTGroup(let groupNames):
            return ("Cannot delete tunnel",
                    "This tunnel is used by the tunnel-in-tunnel group(s): \(groupNames). Remove it from the group(s) first.")
